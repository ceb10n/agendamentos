...
def test_usuario_schema_nome_nao_deve_ter_menos_de_2_caracteres():
    ...
    val_err = excinfo.value
    assert val_err.messages['nome'][0] == 'O nome deve conter entre 2 e 100 caracteres'
...
def test_usuario_schema_email_nao_deve_ter_menos_de_6_caracteres():
    ...
    val_err = excinfo.value
    assert val_err.messages['email'][0] == 'O e-mail deve conter entre 7 e 100 caracteres'
